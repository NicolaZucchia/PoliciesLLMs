...
Please adapt your answer to the following format exactly, without adding "Data: Answer" or any other extra labels:
Other: Yes
Policy Change: No
First Party Collection/Use: Yes
...

Use "Yes" for affirmative answers and "No" for negative answers. Keep the format consistent.
"""
...
if __name__ == "__main__":
    ...
    output_dir = "../Output/gpt35_turbo/textResults/0shot"

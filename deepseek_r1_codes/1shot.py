...
def analyze_policy_with_openai(policy_text, example_policy, example_gt):
    """
...
if __name__ == "__main__":
    ...
    output_dir = "../Output/deepseek/textResults/1shot"
    ...
    for policy_file in policy_files:
        ...
        try:
            ...
            output = analyze_policy_with_openai(policy_text, example_policy_text, example_gt_text)
